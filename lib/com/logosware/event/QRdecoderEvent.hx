...
package com.logosware.event;
	 ...
	 */
	extern class QRdecoderEvent extends Event
	{
		 ...
		 **/
		public static inline var QR_DECODE_COMPLETE:String = "QR_DECODE_COMPLETE";
		...
		public function QRdecoderEvent(type:String, data:String, check:Array<Dynamic>):Void;
